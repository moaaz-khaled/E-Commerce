        ...
        <div class="w-full">
            ...
            <div class="w-full px-10 lg:my-20 lg:p-16 xl:px-32 xl:py-0">
                <form class="space-y-8" action="{{ route('RegisterAccount') }}" method="post">
                    @csrf
                    <div class="relative">
                        <span class="absolute left-2 top-1/2 transform -translate-y-1/2 text-gray-500 text-xl"><img src ="{{ asset('/images/user.png') }}" alt="" /></span>
                    ...
                    <button type="submit" class="w-full bg-gray-300 hover:bg-gray-400 text-black py-3 rounded-lg text-xl font-bold cursor-pointer">Sign Up</button>
                    <div class="h-24 flex justify-evenly items-center gap-x-16 text-white font-bold">
                        ...
                        <button class="bg-gray-300 hover:bg-gray-400 w-32 h-12 text-black cursor-pointer">Sign In</button>
                    </div>
                </form>
            </div>
        </div>
